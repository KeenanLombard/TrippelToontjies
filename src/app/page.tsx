    ...
    <div className='image'>
      <div className='py-10 px-5'>
        <h1 className='text-3xl font-bold text-purple-700'>
          <span className='text-blue-700'>Heading</span> and more
        </h1>
        <p className='font-semibold text-white'>
          Some text from Lorum Ipsum solor amet
        </p>
        <button className='font-semibold text-white p-2 bg-orange-500 rounded-xl'>
          Lees
        </button>
      </div>
      <svg
